...
## 0. First 3 minutes
1. Определи тип задания: Linux / Memory / mixed logs.
...
## Note about Windows
- В этой версии базы ветка `10_windows` отсутствует.
- Когда появится папка `10_windows`, добавь отдельный Windows branch в этот план.
